...
import { qualifiedWordDrawing } from '@/common/constants/animated-drawings'
...
const Qualifications = () => {
    ...
    return (
        <SectionPreview
            sectionRef={qualificationsRef}
            containerClassName={styles.container}
            titleClassName={styles.title}
            animatedWordContainerClassName={styles.animatedWordContainer}
            topRightClassName={styles.graduationCardContainer}
            descriptionClassName={styles.description}
            buttonClassName={styles.button}
            title="A Qualified"
            animatedWord={<AnimatedDrawing drawing={qualifiedWordDrawing} />}
            graphic={<GraduationCard />}
