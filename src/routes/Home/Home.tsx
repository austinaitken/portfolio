...
const Home = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <div>
                <h1>An Experienced Professional</h1>
            </div>
            <div>
