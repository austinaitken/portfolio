    ...
    return (
        <section className={styles.container} ref={experienceRef}>
            <div className={styles.containerTop}>
                <div className={styles.containerTopLeft}>
                    ...
                    <div className={styles.nameContainer}>
                        <svg
                            className={styles.professionalSvg}
                ...
                <div className={styles.containerTopRight}>
                    <img className={styles.nasdaqLogo} src={nasdaqLogo} alt="Nasdaq Logo" />
                </div>
            </div>
            <div className={styles.containerBottom}>
                ...
                <button className={styles.button} onClick={handleVerafinLogoClick}>
                    View Experience
                </button>
            </div>
            {/* <img
